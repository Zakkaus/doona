...
| Rules         | A routing tree from rules through outbounds to the nodes they select, the rule list with hits, the flow log and a routing trace for a chosen target | `rules`, `flows`, `routing_trace`   |
