...
export default function Color({className, ...props}: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <circle cx="10.859" cy="5.521" r="1.5" fill="currentColor" />
      <circle cx="6.859" cy="7.521" r="1.5" fill="currentColor" />
      <circle cx="6.859" cy="12.521" r="1.5" fill="currentColor" />
      <circle cx="10.859" cy="14.521" r="1.5" fill="currentColor" />
      <path
        fill="currentColor"
