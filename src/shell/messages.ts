...
export const messages = defineMessages({
  'zh-TW': {
    ...
    'hint.flows': '規則、出站與所選節點，唯讀；規則旁的數字是目前保留流程的命中數',
    'hint.policies': '策略組與其所選節點',
    'hint.rules': '規則命中統計與路由模擬',
    'hint.dns': '域名解析與快取內容',
  ...
  'zh-CN': {
    ...
    'hint.flows': '规则、出站与所选节点，只读；规则旁的数字是当前保留流程的命中数',
    'hint.policies': '策略组与其所选节点',
    'hint.rules': '规则命中统计与路由模拟',
    'hint.dns': '域名解析与缓存内容',
  ...
  en: {
    ...
    'nav.dns': 'DNS',
    'nav.events': 'Events',
    'nav.flows': 'Routing map',
    'hint.overview': 'Service state and backend features',
    'hint.connections': 'Live connections, grouped by client',
    'hint.flows': 'Rules, outbounds and selected nodes, read-only; the number beside a rule counts its hits among the retained flows',
    'hint.policies': 'Policy groups and their selected nodes',
    'hint.rules': 'Rule hit counts and routing simulation',
