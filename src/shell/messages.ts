...
export const messages = defineMessages({
  'zh-TW': {
    ...
    'hint.connections': '現在誰連到哪',
    'hint.flows': '流量怎麼走：入口、規則、出站、節點',
    'hint.policies': '每個策略組走哪個節點',
    'hint.rules': '規則命中了什麼，怎麼判定',
    'hint.dns': '域名怎麼解析，快取裡有什麼',
    'hint.events': '後端剛發生了什麼',
    'grp.status': '狀態',
    'grp.network': '網路',
    'grp.proxy': '代理',
    'grp.system': '系統',
  ...
  'zh-CN': {
    ...
    'hint.connections': '现在谁连到哪',
    'hint.flows': '流量怎么走：入口、规则、出站、节点',
    'hint.policies': '每个策略组走哪个节点',
    'hint.rules': '规则命中了什么，怎么判定',
    'hint.dns': '域名怎么解析，缓存里有什么',
    'hint.events': '后端刚发生了什么',
    'grp.status': '状态',
    'grp.network': '网络',
    'grp.proxy': '代理',
    'grp.system': '系统',
  ...
  en: {
    ...
    'hint.connections': 'Who is connected to what right now',
    'hint.flows': 'How traffic travels: ingress, rule, outbound, node',
    'hint.policies': 'Which node each policy group uses',
    'hint.rules': 'What the rules matched and how a request is decided',
    'hint.dns': 'How names resolve and what the cache holds',
    'hint.events': 'What the backend just did',
    'grp.status': 'Status',
    'grp.network': 'Network',
    'grp.proxy': 'Proxy',
    'grp.system': 'System',
