...
export const messages = defineMessages({
  'zh-TW': {
    ...
    'policy.note': '僅 selector 群組可切換成員，TCP 與 UDP 可分別選擇。',
    'policy.empty': '沒有群組。',
  ...
  'zh-CN': {
    ...
    'policy.note': '仅 selector 组可切换成员，TCP 与 UDP 可分别选择。',
    'policy.empty': '没有组。',
  ...
  en: {
    ...
    'policy.note': 'Only selector groups can switch members; TCP and UDP are chosen separately.',
