...
export const messages = defineMessages({
  'zh-TW': {
    ...
    'mode.global': '全域',
    'act.apply': '應用',
    'act.modeApplied': '出站模式已寫入配置並重載：{mode}',
    'act.modeInvalid': '校驗發現 {n} 個錯誤，未寫入',
    'act.modeNoRouting': '主配置沒有 routing 區段',
    'act.modeNeedsWrite': '需要可寫的主配置',
  ...
  'zh-CN': {
    ...
    'act.modeNoRouting': '主配置没有 routing 区段',
    'act.modeNeedsWrite': '需要可写的主配置',
  ...
  en: {
    ...
    'act.modeInvalid': 'Validation found {n} errors; nothing written',
