...
export const messages = defineMessages({
  'zh-TW': {
    ...
    'dns.viewCache': '查看快取',
    'dns.log': '解析記錄',
    'dns.exportLog': '匯出已載入記錄 CSV',
    'dns.result': '結果',
    'dns.logFilterHint': '網域包含',
    'dns.logTotal': '環形緩衝區內有 {n} 筆記錄',
    'dns.logLoaded': '已載入 {n} 筆記錄，匯出僅包含這些記錄',
  ...
  'zh-CN': {
    ...
    'dns.viewCache': '查看缓存',
    'dns.log': '解析记录',
    'dns.exportLog': '导出已加载记录 CSV',
    'dns.result': '结果',
    'dns.logFilterHint': '域名包含',
    'dns.logTotal': '环形缓冲区内有 {n} 条记录',
    'dns.logLoaded': '已加载 {n} 条记录，导出仅包含这些记录',
  ...
  en: {
    ...
    'dns.exportLog': 'Export loaded CSV',
    'dns.result': 'Result',
    'dns.logFilterHint': 'Name contains',
    'dns.logTotal': {one: '{n} record in the ring buffer', other: '{n} records in the ring buffer'},
    'dns.logLoaded': {one: '{n} loaded record; export includes only this record', other: '{n} loaded records; export includes only these records'},
