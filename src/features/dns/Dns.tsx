      ...
      <div className="rp-split">
        <div className="rp-col">
          ...
          <DataTable
            ...
            cols={[
              {id: 'id', label: t('dns.id'), width: 80},
              {id: 'q', label: t('ui.domain'), isRowHeader: true},
              {id: 't', label: t('ui.type'), width: 70},
              {id: 's', label: t('ui.state'), width: 100},
              {id: 'e', label: t('dns.expires'), width: 100},
              {id: 'st', label: t('dns.staleUntil'), width: 110},
              {id: 'a', label: t('ui.delete'), width: 64}
            ]}
            render={entry => [
              entry.entry_id,
        ...
        <div className="rp-card">
          <h3 className="rp-h3">{t('dns.flush')}</h3>
          <Kv
            items={[
