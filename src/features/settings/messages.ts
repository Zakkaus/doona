...
export const messages = defineMessages({
  'zh-TW': {
    ...
    'settings.flushConfirm': '將清除全部 DNS 快取記錄，無法復原。',
  ...
  'zh-CN': {
    ...
    'settings.flushConfirm': '将清除全部 DNS 缓存记录，无法恢复。',
  ...
  en: {
    ...
    'settings.flushConfirm': 'Clears every DNS cache record; this cannot be undone.',
