...
export const messages = defineMessages({
  'zh-TW': {
    ...
    'settings.recordingAttached': '面板已連線，隨面板的記錄器正在記錄。',
    'settings.recordingDetached': '沒有面板連線，隨面板的記錄器暫停；打開流程或事件頁就會開始。',
  ...
  'zh-CN': {
    ...
    'settings.recordingAttached': '面板已连接，随面板的记录器正在记录。',
    'settings.recordingDetached': '没有面板连接，随面板的记录器暂停；打开流程或事件页就会开始。',
  ...
  en: {
    ...
    'settings.recordingAttached': 'A panel is attached; recorders set to follow it are recording.',
    'settings.recordingDetached': 'No panel is attached; recorders set to follow it are idle and start when the flows or events page opens.',
