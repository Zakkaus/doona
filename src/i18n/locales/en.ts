...
export const messages = {
  ...
  'policy.note':
    'Manual groups switch members directly. Automatic groups follow their configured policy; pinning is available only when the backend supports it. TCP and UDP can be selected separately.',
  ...
  'policy.selectedNode': 'Selected TCP node: {name}',
