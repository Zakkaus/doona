...
export const messages = {
  ...
  'config.redacted': 'Listener secret values are redacted',
  ...
  'config.newSource': 'New file',
  'config.newSourceTitle': 'New configuration file',
  'config.newSourceHelp':
    "The file starts empty and loads only when an include pattern of the main configuration matches its path. The path is relative to the main configuration's directory.",
  ...
  'config.newSourceExtension': 'The file name must end in .dae',
  'config.newSourceControl': 'The path cannot contain control characters',
  'config.newSourceNameHelp':
    'The file starts empty. Its directory and extension come from an include pattern of the main configuration, so enter only the name.',
  'config.newSourcePattern': 'Include pattern',
  'config.newSourceName': 'Name',
  'config.newSourceNameSlash': 'The name cannot contain /',
  'config.newSourceNameControl': 'The name cannot contain control characters',
  ...
  'config.repeated': '{text} ({n} times)',
  'config.backendDetail': '{text}. Backend message: {message}',
  ...
  'conn.filtersActive': {one: 'Filters, {n} applied', other: 'Filters, {n} applied'},
  'conn.allDevices': 'All devices',
  'conn.allRules': 'All rules',
  ...
  'dns.deleted': {one: 'Deleted {n} cache entry', other: 'Deleted {n} cache entries'},
  'dns.deleteFailed': 'Could not delete the cache entry',
  ...
  'dns.chart.shortPage': 'The backend ended this page early: {n} of {limit} records',
  ...
  'event.gapNoCount': '{id}, reason: {reason}',
  ...
  'nodes.agent': 'User-Agent',
  'nodes.agentInvalid': 'Up to 256 printable ASCII characters',
  'nodes.cache': 'Cache the subscription',
  ...
  'ov.operationError': 'Could not run the operation',
  ...
  'policy.members': {one: '{n} member', other: '{n} members'},
  ...
  'rule.simulatedAddress': 'Simulated address',
  ...
  'settings.recordingEvents': "Event capture is running: a panel is attached or a recorder is pinned on. Each recorder's light shows whether it is recording.",
  ...
  'settings.refreshedAllFailed': 'Subscriptions refreshed: {n} of {total}; {failed} failed',
