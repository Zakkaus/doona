...
import {messages as nodes} from '../features/nodes/messages';
...
export const modules = [shell, ui, activity, overview, connections, flows, policies, nodes, rules, config, dns, events, settings] as const;
