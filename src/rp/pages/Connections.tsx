        ...
        {cur ? (
          <div className="rp-card">
            ...
            <div className="rp-col">
              ...
              {cur.chain[0] === proxy.name && <LabeledSelect label={proxy.name + ' 的選擇（只影響後續撥號）'} value={proxy.selected ?? proxy.members[0]} onChange={k => toast('positive', proxy.name + ' 已切換至 ' + k + '，已儲存')} items={proxy.members.map(m => ({id: m, label: m}))} />}
