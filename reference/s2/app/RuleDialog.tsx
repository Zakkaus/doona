          ...
          <>
            ...
            <Content>
              <Form>
                ...
                <Picker label="目標" selectedKey={target} onSelectionChange={k => setTarget(String(k))}>
                  {targets.map(t => (
                ...
                <Picker label="位置" defaultSelectedKey="before-fallback">
                  <PickerItem id="before-fallback">fallback 之前（config.dae:44）</PickerItem>
                  <PickerItem id="before-hit">命中的規則之前</PickerItem>
                  <PickerItem id="rules-end">rules.dae 結尾</PickerItem>
                </Picker>
            ...
            <ButtonGroup>
              ...
              <Button
                ...
                onPress={() => {
                  close();
                  toast('positive', '已加入規則，reload 完成（r' + (runtime.diskRevision + 1) + '）');
                }}
              >
                加入並 reload
              </Button>
