...
The recipes use tag `v0.1.0-beta.7`. Release assets keep the upstream version without the tag's `v`;
...
| ---------------- | --------------------------------------------- | -------------------------------------------------- |
| Program archive  | `doona-0.1.0-beta.7.tar.gz`                   | n/a                                                |
| Fonts archive    | `doona-fonts-0.1.0-beta.7.tar.gz`             | n/a                                                |
| Debian           | `doona_0.1.0-beta.7-1_all.deb`                | `0.1.0~beta.7-1`                                   |
| RPM              | `doona-0.1.0-beta.7-1.noarch.rpm`             | Version `0.1.0~beta.7`, Release `1`                |
| OpenWrt ipk      | `doona_0.1.0-beta.7-1_all.ipk`                | `0.1.0~beta.7-1`                                   |
| Arch             | `doona-0.1.0beta7-1-any.pkg.tar.zst`          | pkgver `0.1.0beta7`, pkgrel `1`, default epoch `0` |
| Alpine APKBUILD  | Download the program and fonts archives above | pkgver `0.1.0_beta7`, pkgrel `0`                   |
| Gentoo ebuild    | Download the program and fonts archives above | PV `0.1.0_beta7`                                   |
| OpenWrt Makefile | Download the program and fonts archives above | PKG_VERSION `0.1.0_beta7`, PKG_RELEASE `1`         |
| Nix recipe       | Download the program and fonts archives above | `0.1.0-beta.7`                                     |
...
under the subject `net-proxy/doona: new package, add 0.1.0_beta7`, keep the `Manifest` in the same commit, and add
